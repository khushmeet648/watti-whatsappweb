...
<div class="wrapper">
  ...
  <div class="container-fluid">
                ...
                <div class="btn btn-outline-light" id="borders">
                    <div class="row">
                        <div class="col">
                        ...
                        <div class="col mt-2  ml-0">
                                <h6 class="text-dark"><b>To get the chat  backup file, use the extension from the link below</b></h6>
                                <a href=""><u>Available in the Chrome Web Store</u></a>
                        </div>
                    </div>
                </div>
<br>
                <div class="btn btn-outline-light d-flex justify-content-center" id="border1">
                    <div class="row">
                      
                                <h5 class="text-dark my-3"><b> Upload the chat backup(zip) here </b></h5>
